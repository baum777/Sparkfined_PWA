...
> 
> **📝 Consolidated Document**: This guide merges content from `UI_STYLE_GUIDE.md`, `DESIGN_TOKENS_STYLEGUIDE_DE.md`, `colors.md`, and `overview.md`. For component-specific details, see:
> - [Buttons](buttons.md), [Cards](cards.md), [Typography](typography.md)
> - [Glassmorphism](glassmorphism.md), [Effects](effects.md)
