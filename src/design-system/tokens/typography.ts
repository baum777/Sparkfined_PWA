export const typography = {
  ...
  fontSize: {
    ...
    '3xl': ['2rem', { lineHeight: '1.25', fontWeight: '700', letterSpacing: '-0.02em' }],
    '4xl': ['2.5rem', { lineHeight: '1.2', fontWeight: '700', letterSpacing: '-0.02em' }],
    '5xl': ['3rem', { lineHeight: '1.2', fontWeight: '900', letterSpacing: '-0.02em' }],
  },
  fontWeight: {
    normal: 400,
    medium: 500,
