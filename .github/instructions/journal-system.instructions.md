---
description: Journal system domain rules - Hero's Journey trading journal with AI insights
applyTo: >-
  src/pages/JournalPageV2.tsx,src/components/journal/**/*.{ts,tsx},src/lib/JournalService.ts,src/lib/journal/**/*.ts,src/store/journalStore.ts,tests/e2e/journal/**/*.spec.ts,tests/e2e/journal-crud.spec.ts,tests/components/Journal*.test.tsx,tests/pages/JournalPageV2.test.tsx,docs/core/journal/**/*.md
---
